...
the laboratory-frame rapidity range $-3.5<y<3.5$, where this $y$ denotes jet
rapidity and not the DIS inelasticity. In addition,
...
have laboratory-frame rapidity $-3.5<y<3.5$. In the showered
...
laboratory-frame rapidity $-3.5<y<3.5$, and the third jet is
