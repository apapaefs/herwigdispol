...
\end{eqnarray}
\end{subequations}
For transversely-polarized hadrons, an additional distribution $\Delta_T f_i(x,Q^2)$ is required. It gives the difference between parton densities with polarization parallel and antiparallel to that of the hadron. For details, see Sec.~1 of Ref.\,\cite{Barone:2001sp}.
...
parton level, bypassing any shower reconstruction. For this differential comparison, the unpolarized and polarized
...
while the accepted-emission density matrix gives a smaller incremental effect. We note here that additional fourth-jet angular and asymmetry observables were attempted, yielding the same conclusion.
