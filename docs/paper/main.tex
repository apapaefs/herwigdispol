...
Several extensions now follow naturally. A broader survey of exclusive
shower and jet observables, beyond the exploratory set considered here,
would map out where measurements are most sensitive to the Born-level
spin-density initialization, and a quantitative study of the stability of
the spin-on versus spin-disabled differences under variations of shower
and hadronization settings would sharpen this comparison.
The polarized DIS hard process and the spin-correlation treatment described
here will be made publicly available in a future \Herwig\ release. More
