...
public:
  ...
  /**
   * Return the PDF-set alphaS value at the requested scale.
   *
   * This mirrors the LHAPDF `alphasQ2` call used by fixed-order codes
   * such as POLDIS when the same PDF set provides both the densities and
   * the running coupling.
   */
  double alphaS(Energy2 partonScale) const;
