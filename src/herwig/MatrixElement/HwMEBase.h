...
public:
  ...
  /**
   *  Get the spin density matrices for the incoming particles
   */
  pair<RhoDMatrix,RhoDMatrix> getRhoMatrices() const;

  /** 
   *  Get the beam polarization
   */
  ThreeVector<double> getBeamPolarization(bool firstOrSecond) const;
...
private:
  ...
  /**
   *  Whether or not collisions are polarized
   */
  mutable bool _polarized = true;
