...
protected:
   ...
   **/
  InvEnergy2 qqbarME(pair<RhoDMatrix,RhoDMatrix> & rhoin,
   ...
   * @param me   Whether or not to calculate the matrix element for spin correlations
   **/
  InvEnergy2 qgME(pair<RhoDMatrix,RhoDMatrix> & rhoin,
		  vector<SpinorWaveFunction> & fin,
   ...
   * @param me   Whether or not to calculate the matrix element for spin correlations
   **/
  InvEnergy2 qbargME(pair<RhoDMatrix,RhoDMatrix> & rhoin,
