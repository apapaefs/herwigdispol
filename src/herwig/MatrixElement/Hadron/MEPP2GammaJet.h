...
private:
   ...
   */
  double qqbarME(const pair<RhoDMatrix,RhoDMatrix> & rhoin ,
   ...
   * @param me    Whether or not to calculate the matrix element for spin correlations
   */
  double qgME(const pair<RhoDMatrix,RhoDMatrix> & rhoin ,
              const vector<SpinorWaveFunction> & fin,
   ...
   * @param me    Whether or not to calculate the matrix element for spin correlations
   */
  double qbargME(const pair<RhoDMatrix,RhoDMatrix> & rhoin ,
                 const vector<SpinorBarWaveFunction> & ain,
                 const vector<VectorWaveFunction> & gin,
		 const vector<VectorWaveFunction> & pout,
