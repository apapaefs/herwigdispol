// -*- C++ -*-
#ifndef Herwig_OneZeroZeroEWSplitFn_H
#define Herwig_OneZeroZeroEWSplitFn_H
//
...
/**
 * The OneZeroZeroEWSplitFn class implements the splitting function for
...
private:
   ...
   */
  OneZeroZeroEWSplitFn & operator=(const OneZeroZeroEWSplitFn &) = delete;
...
#endif /* Herwig_OneZeroZeroEWSplitFn_H */
