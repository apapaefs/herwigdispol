// -*- C++ -*-
#ifndef Herwig_OneOneOneQEDSplitFn_H
#define Herwig_OneOneOneQEDSplitFn_H
//
...
private:
   ...
   */
  OneOneOneQEDSplitFn & operator=(const OneOneOneQEDSplitFn &) = delete;
...
#endif /* Herwig_OneOneOneQEDSplitFn_H */
