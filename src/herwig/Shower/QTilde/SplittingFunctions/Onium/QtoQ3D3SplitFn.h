// -*- C++ -*-
#ifndef Herwig_QtoQ3D3SplitFn_H
#define Herwig_QtoQ3D3SplitFn_H
//
// This is the declaration of the QtoQ3D3SplitFn class.
//
...
/**
 * The QtoQ3D3SplitFn class implements the splitting function for \f$q\to q M_q\bar{q}(^3D_3)\f$.
 *
 * @see \ref QtoQ3D3SplitFnInterfaces "The interfaces"
 * defined for QtoQ3D3SplitFn.
 */
class QtoQ3D3SplitFn: public Sudakov1to2FormFactor {
...
public:
   ...
   */
  QtoQ3D3SplitFn() : O1_(0.131*GeV*pow<3,1>(GeV2)), state_(ccbar), n_(1), fixedAlphaS_(-1.)
  {}
  ...
  bool accept(const IdList & ids) const {
    ...
    long idtest = ids[0]->id()*110 + 7 + (n_-1)*100000;
...
private:
   ...
   */
  QtoQ3D3SplitFn & operator=(const QtoQ3D3SplitFn &) = delete;
