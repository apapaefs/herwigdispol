// -*- C++ -*-
#ifndef Herwig_QtoQ1S0SplitFn_H
#define Herwig_QtoQ1S0SplitFn_H
//
// This is the declaration of the QtoQ1S0SplitFn class.
//
...
/**
 * The QtoQ1S0SplitFn class implements the splitting function for \f$q\to q M_q\bar{q}(^1S_0)\f$
 *
 * @see \ref QtoQ1S0SplitFnInterfaces "The interfaces"
 * defined for QtoQ1S0SplitFn.
 */
class QtoQ1S0SplitFn: public Sudakov1to2FormFactor {
...
public:
   ...
   */
  QtoQ1S0SplitFn() : O1_(0.573*GeV*GeV2), state_(ccbar), n_(1), fixedAlphaS_(-1.)
  {}
...
public:
  ...
  bool accept(const IdList & ids) const {
    ...
    long idtest = ids[0]->id()*110+1 + (n_-1)*100000;
...
private:
   ...
   */
  QtoQ1S0SplitFn & operator=(const QtoQ1S0SplitFn &) = delete;
