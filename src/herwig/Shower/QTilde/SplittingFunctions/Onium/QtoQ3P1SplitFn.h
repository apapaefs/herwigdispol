// -*- C++ -*-
#ifndef Herwig_QtoQ3P1SplitFn_H
#define Herwig_QtoQ3P1SplitFn_H
//
// This is the declaration of the QtoQ3P1SplitFn class.
//
...
/**
 * The QtoQ3P1SplitFn class implements the splitting function for \f$q\to q' M_q\bar{q}(P_1)'\f$,
 * in this case there is mixing between the $\phanton{A}^1P_1$ and $\phanton{A}^3P_1$ states
 *
 * @see \ref QtoQ3P1SplitFnInterfaces "The interfaces"
 * defined for QtoQ3P1SplitFn.
 */
class QtoQ3P1SplitFn: public Sudakov1to2FormFactor {
...
public:
   ...
   */
  QtoQ3P1SplitFn() : O1_(0.794*GeV*GeV2*GeV2), state_(ccbar), n_(1), fixedAlphaS_(-1.)
  {}
  //@}
  ...
  bool accept(const IdList & ids) const {
    ...
    long idtest = ids[0]->id()*110+3 + 20000 + (n_-1)*100000;
...
private:
   ...
   */
  QtoQ3P1SplitFn & operator=(const QtoQ3P1SplitFn &) = delete;
