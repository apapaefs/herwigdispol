// -*- C++ -*-
#ifndef Herwig_QtoQPBarQQP1SplitFn_H
#define Herwig_QtoQPBarQQP1SplitFn_H
//
// This is the declaration of the QtoQPBarQQP1SplitFn class.
//
...
/**
 * The QtoQPBarQQP1SplitFn class implements the splitting function for \f$q\to \bar{q'} {qq'}_1\f$
 *
 * @see \ref QtoQPBarQQP1SplitFnInterfaces "The interfaces"
 * defined for QtoQPBarQQP1SplitFn.
 */
class QtoQPBarQQP1SplitFn: public Sudakov1to2FormFactor {
...
private:
   ...
   */
  QtoQPBarQQP1SplitFn & operator=(const QtoQPBarQQP1SplitFn &) = delete;
...
#endif /* Herwig_QtoQPBarQQP1SplitFn_H */
