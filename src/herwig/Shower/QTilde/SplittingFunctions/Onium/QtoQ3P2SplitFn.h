// -*- C++ -*-
#ifndef Herwig_QtoQ3P2SplitFn_H
#define Herwig_QtoQ3P2SplitFn_H
//
// This is the declaration of the QtoQ3P2SplitFn class.
//
...
/**
 * The QtoQ3P2SplitFn class implements the splitting function for \f$q\to q M_q\bar{q}(^3P_2)\f$
 *
 * @see \ref QtoQ3P2SplitFnInterfaces "The interfaces"
 * defined for QtoQ3P2SplitFn.
 */
class QtoQ3P2SplitFn: public Sudakov1to2FormFactor {
...
public:
   ...
   */
  QtoQ3P2SplitFn() : O1_(0.794*GeV*GeV2*GeV2), state_(ccbar), n_(1), fixedAlphaS_(-1.)
  {}
  //@}
  ...
  bool accept(const IdList & ids) const {
    ...
    long idtest = ids[0]->id()*110+5 + (n_-1)*100000;
...
private:
   ...
   */
  QtoQ3P2SplitFn & operator=(const QtoQ3P2SplitFn &) = delete;
