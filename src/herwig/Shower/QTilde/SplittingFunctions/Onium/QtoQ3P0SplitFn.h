// -*- C++ -*-
#ifndef Herwig_QtoQ3P0SplitFn_H
#define Herwig_QtoQ3P0SplitFn_H
//
// This is the declaration of the QtoQ3P0SplitFn class.
//
...
/**
 * The QtoQ3P0SplitFn class implements the splitting function for \f$q\to q M_q\bar{q}(^3P_0)\f$
 *
 * @see \ref QtoQ3P0SplitFnInterfaces "The interfaces"
 * defined for QtoQ3P0SplitFn.
 */
class QtoQ3P0SplitFn: public Sudakov1to2FormFactor {
...
public:
   ...
   */
  QtoQ3P0SplitFn() : O1_(0.794*GeV*GeV2*GeV2), state_(ccbar), n_(1), fixedAlphaS_(-1.)
  {}
  //@}
  ...
  bool accept(const IdList & ids) const {
    ...
    if(ids[0]->id()!=4+state_) return false;
    // construct the meson PDG code from quark ids and check it
    long idtest = ids[0]->id()*110+1 + 10000 + (n_-1)*100000;
...
private:
   ...
   */
  QtoQ3P0SplitFn & operator=(const QtoQ3P0SplitFn &) = delete;
