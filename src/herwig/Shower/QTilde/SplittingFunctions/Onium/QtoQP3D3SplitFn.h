// -*- C++ -*-
#ifndef Herwig_QtoQP3D3SplitFn_H
#define Herwig_QtoQP3D3SplitFn_H
//
// This is the declaration of the QtoQP3D3SplitFn class.
//
...
/**
 * The QtoQP3D3SplitFn class implements the splitting function for \f$q\to q' M_q\bar{q'}(^3D_3)\f$,
 *
 * @see \ref QtoQP3D3SplitFnInterfaces "The interfaces"
 * defined for QtoQP3D3SplitFn.
 */
class QtoQP3D3SplitFn: public Sudakov1to2FormFactor {
...
public:
   ...
   */
  QtoQP3D3SplitFn() : O1_(0.131*GeV*pow<3,1>(GeV2)), state_(bcbar), n_(1), fixedAlphaS_(-1.)
  {}
  ...
  bool accept(const IdList & ids) const {
    ...
    long idtest = id1*100+id2*10+7 + (n_-1)*100000;
...
private:
   ...
   */
  QtoQP3D3SplitFn & operator=(const QtoQP3D3SplitFn &) = delete;
...
#endif /* Herwig_QtoQP3D3SplitFn_H */
