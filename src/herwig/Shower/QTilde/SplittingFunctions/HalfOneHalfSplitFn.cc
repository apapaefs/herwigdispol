...
HalfOneHalfSplitFn::forwardPhiWeights(const double, const Energy2, const IdList & ,
				       const RhoDMatrix &) {
...
vector<pair<int, Complex> > 
HalfOneHalfSplitFn::backwardPhiWeights(const double z, const Energy2 t, const IdList & ids,
