...
OneOneOneDarkSplitFn::forwardPhiWeights(const double z, const Energy2, const IdList &,
...
vector<pair<int, Complex> >
OneOneOneDarkSplitFn::backwardPhiWeights(const double z, const Energy2, const IdList &,
			      const RhoDMatrix & rho) {
  assert(rho.iSpin()==PDT::Spin1);
