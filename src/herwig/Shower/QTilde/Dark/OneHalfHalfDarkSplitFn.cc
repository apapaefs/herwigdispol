...
OneHalfHalfDarkSplitFn::forwardPhiWeights(const double z, const Energy2 t, const IdList & ids,
...
vector<pair<int, Complex> >
OneHalfHalfDarkSplitFn::backwardPhiWeights(const double, const Energy2, const IdList &,
					const RhoDMatrix & ) {
  // no dependance
  return {{ {0, 1.} }};
}
