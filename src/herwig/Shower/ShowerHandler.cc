...
void ShowerHandler::cascade() {
  ...
  // // stuff for polarized hadrons
  Ptr<ThePEG::PolarizedPartonExtractor>::ptr polExtractor = dynamic_ptr_cast<Ptr<ThePEG::PolarizedPartonExtractor>::ptr >(lastExtractor());
  isPolarized_ = make_pair(false,false);
  ...
  if (polExtractor) {
    ...
    longpdfs_ = polExtractor->longitudinalDifferencePDF();
    transpdfs_ = polExtractor->transverseDifferencePDF();
  }
