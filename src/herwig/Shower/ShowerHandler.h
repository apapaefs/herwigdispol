...
protected:
  ...
  /**
   *   Information for beam polarization
   */
  //@{
  /**
   ...
   * Beam polarizations
   */
  pair<ThreeVector<double>, ThreeVector<double> > polarization() const {
   ...
   */
  pair <PDFPtr, PDFPtr> longitudinalPDF() const {return longpdfs_;}

  /**
   *   Transverse difference pdfs
   */
  pair <PDFPtr, PDFPtr> transversePDF() const {return transpdfs_;}
  //@}
...
private:
   ...
   *  Whether or not beams are polarized
   */
  pair<bool,bool> isPolarized_;

  /**
   * Beam polarizations
   */
  pair<ThreeVector<double>,
       ThreeVector<double> > polarization_;

  /**
   *   Longitudinal difference pdfs
   */
  pair <PDFPtr, PDFPtr> longpdfs_;

  /**
   *   Transverse difference pdfs
   */
  pair <PDFPtr, PDFPtr> transpdfs_;
  //@}
