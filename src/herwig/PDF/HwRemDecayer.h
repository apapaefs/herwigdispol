...
public:
  ...
  HwRemDecayer() : allowTop_(false), allowLeptons_(false), 
		   ...
		   DISOneRemnantFallbackOpt_(0), PtDistribution_(0),
...
private:
  ...
  /**
   *  Optional recovery mode for one-remnant DIS events that cannot
   *  otherwise put the remnant on shell.
   */
  unsigned int DISOneRemnantFallbackOpt_;
